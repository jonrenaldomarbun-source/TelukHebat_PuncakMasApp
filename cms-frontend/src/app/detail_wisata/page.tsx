        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              <h2 className="text-2xl font-black mb-4">Tentang Wisata</h2>
            ...
            {/* FASILITAS */}
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              <h2 className="text-2xl font-black mb-6">Fasilitas Utama</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {data.fasilitas.map((item, index) => (
                  <div
                    key={index}
                    className="p-4 bg-slate-50 rounded-2xl border hover:border-blue-200 hover:shadow-md transition-all"
                  >
                    {item}
                  </div>
                ))}
          ...
          {/* SIDEBAR */}
          <div>
            <div className="bg-blue-600 p-8 rounded-3xl shadow-xl text-white sticky top-8">
              ...
              <button
                ...
                className="w-full bg-white text-blue-600 font-black py-4 rounded-2xl mt-8 hover:bg-blue-50 transition-colors"
              >
                Beli Tiket Sekarang
              </button>
            </div>
